...
@JvmInline
value class VkDebugUtilsMessageSeverityEXT(val i: VkDebugUtilsMessageSeverityFlagsEXT) {
    companion object {
...
@JvmInline
value class VkDebugUtilsMessageTypeEXT(val i: VkDebugUtilsMessageTypeFlagsEXT) {
    companion object {
