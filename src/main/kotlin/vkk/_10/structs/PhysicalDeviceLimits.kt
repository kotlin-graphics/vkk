...
class PhysicalDeviceLimits(
    ...
    constructor(ptr: BytePtr) : this(
            nmaxImageDimension1D(ptr.adr),
            nmaxImageDimension2D(ptr.adr),
            nmaxImageDimension3D(ptr.adr),
            nmaxImageDimensionCube(ptr.adr),
            nmaxImageArrayLayers(ptr.adr),
            nmaxTexelBufferElements(ptr.adr),
            nmaxUniformBufferRange(ptr.adr),
            nmaxStorageBufferRange(ptr.adr),
            nmaxPushConstantsSize(ptr.adr),
            nmaxMemoryAllocationCount(ptr.adr),
            nmaxSamplerAllocationCount(ptr.adr),
            VkDeviceSize(nbufferImageGranularity(ptr.adr)),
            VkDeviceSize(nsparseAddressSpaceSize(ptr.adr)),
            nmaxBoundDescriptorSets(ptr.adr),
            nmaxPerStageDescriptorSamplers(ptr.adr),
            nmaxPerStageDescriptorUniformBuffers(ptr.adr),
            nmaxPerStageDescriptorStorageBuffers(ptr.adr),
            nmaxPerStageDescriptorSampledImages(ptr.adr),
            nmaxPerStageDescriptorStorageImages(ptr.adr),
            nmaxPerStageDescriptorInputAttachments(ptr.adr),
            nmaxPerStageResources(ptr.adr),
            nmaxDescriptorSetSamplers(ptr.adr),
            nmaxDescriptorSetUniformBuffers(ptr.adr),
            nmaxDescriptorSetUniformBuffersDynamic(ptr.adr),
            nmaxDescriptorSetStorageBuffers(ptr.adr),
            nmaxDescriptorSetStorageBuffersDynamic(ptr.adr),
            nmaxDescriptorSetSampledImages(ptr.adr),
            nmaxDescriptorSetStorageImages(ptr.adr),
            nmaxDescriptorSetInputAttachments(ptr.adr),
            nmaxVertexInputAttributes(ptr.adr),
            nmaxVertexInputBindings(ptr.adr),
            nmaxVertexInputAttributeOffset(ptr.adr),
            nmaxVertexInputBindingStride(ptr.adr),
            nmaxVertexOutputComponents(ptr.adr),
            nmaxTessellationGenerationLevel(ptr.adr),
            nmaxTessellationPatchSize(ptr.adr),
            nmaxTessellationControlPerVertexInputComponents(ptr.adr),
            nmaxTessellationControlPerVertexOutputComponents(ptr.adr),
            nmaxTessellationControlPerPatchOutputComponents(ptr.adr),
            nmaxTessellationControlTotalOutputComponents(ptr.adr),
            nmaxTessellationEvaluationInputComponents(ptr.adr),
            nmaxTessellationEvaluationOutputComponents(ptr.adr),
            nmaxGeometryShaderInvocations(ptr.adr),
            nmaxGeometryInputComponents(ptr.adr),
            nmaxGeometryOutputComponents(ptr.adr),
            nmaxGeometryOutputVertices(ptr.adr),
            nmaxGeometryTotalOutputComponents(ptr.adr),
            nmaxFragmentInputComponents(ptr.adr),
            nmaxFragmentOutputAttachments(ptr.adr),
            nmaxFragmentDualSrcAttachments(ptr.adr),
            nmaxFragmentCombinedOutputResources(ptr.adr),
            nmaxComputeSharedMemorySize(ptr.adr),
            Vec3i(nmaxComputeWorkGroupCount(ptr.adr)),
            nmaxComputeWorkGroupInvocations(ptr.adr),
            Vec3i(nmaxComputeWorkGroupSize(ptr.adr)),
            nsubPixelPrecisionBits(ptr.adr),
            nsubTexelPrecisionBits(ptr.adr),
            nmipmapPrecisionBits(ptr.adr),
            nmaxDrawIndexedIndexValue(ptr.adr),
            nmaxDrawIndirectCount(ptr.adr),
            nmaxSamplerLodBias(ptr.adr),
            nmaxSamplerAnisotropy(ptr.adr),
            nmaxViewports(ptr.adr),
            Vec2i(nmaxViewportDimensions(ptr.adr)),
            Vec2(nviewportBoundsRange(ptr.adr)),
            nviewportSubPixelBits(ptr.adr),
            nminMemoryMapAlignment(ptr.adr),
            VkDeviceSize(nminTexelBufferOffsetAlignment(ptr.adr)),
            VkDeviceSize(nminUniformBufferOffsetAlignment(ptr.adr)),
            VkDeviceSize(nminStorageBufferOffsetAlignment(ptr.adr)),
            nminTexelOffset(ptr.adr),
            nmaxTexelOffset(ptr.adr),
            nminTexelGatherOffset(ptr.adr),
            nmaxTexelGatherOffset(ptr.adr),
            nminInterpolationOffset(ptr.adr),
            nmaxInterpolationOffset(ptr.adr),
            nsubPixelInterpolationOffsetBits(ptr.adr),
            nmaxFramebufferWidth(ptr.adr),
            nmaxFramebufferHeight(ptr.adr),
            nmaxFramebufferLayers(ptr.adr),
            nframebufferColorSampleCounts(ptr.adr),
            nframebufferDepthSampleCounts(ptr.adr),
            nframebufferStencilSampleCounts(ptr.adr),
            nframebufferNoAttachmentsSampleCounts(ptr.adr),
            nmaxColorAttachments(ptr.adr),
            nsampledImageColorSampleCounts(ptr.adr),
            nsampledImageIntegerSampleCounts(ptr.adr),
            nsampledImageDepthSampleCounts(ptr.adr),
            nsampledImageStencilSampleCounts(ptr.adr),
            nstorageImageSampleCounts(ptr.adr),
            nmaxSampleMaskWords(ptr.adr),
            ntimestampComputeAndGraphics(ptr.adr).bool,
            ntimestampPeriod(ptr.adr),
            nmaxClipDistances(ptr.adr),
            nmaxCullDistances(ptr.adr),
            nmaxCombinedClipAndCullDistances(ptr.adr),
            ndiscreteQueuePriorities(ptr.adr),
            Vec2(npointSizeRange(ptr.adr)),
            Vec2(nlineWidthRange(ptr.adr)),
            npointSizeGranularity(ptr.adr),
            nlineWidthGranularity(ptr.adr),
            nstrictLines(ptr.adr).bool,
            nstandardSampleLocations(ptr.adr).bool,
            VkDeviceSize(noptimalBufferCopyOffsetAlignment(ptr.adr)),
            VkDeviceSize(noptimalBufferCopyRowPitchAlignment(ptr.adr)),
            VkDeviceSize(nnonCoherentAtomSize(ptr.adr))
    )
}